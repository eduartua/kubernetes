...
Pod’s SELinux context, if specified
  * A stable client library release\_1\_2 is added. The library is [here](pkg/client/clientset_generated/), and detailed doc is [here](https://git.k8s.io/community/contributors/devel/sig-API-Machinery//generating-clientset.md#released-clientsets). We will keep the interface of this go client stable.
